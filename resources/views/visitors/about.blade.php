...
<head>
    ...
    <link href="imported-css.css" rel="stylesheet" />
    <link href="css2/plugins.css" rel="stylesheet">
    <link href="css2/style.css" rel="stylesheet">


    <link
        href="https://fonts.googleapis.com/css2?family=Lora:wght@400;500&amp;family=Mulish:wght@200;400&amp;family=Raleway:wght@200;400;500&amp;display=swap"
        rel="stylesheet">
    ...
    <link rel="stylesheet" href=general8195.css?id=12438>
    ...
    <div class="header-inner">
                ...
                <div class="container hhwwjwjku72jk">
                    <nav>
                        <ul>
                            ...
                            <li><a href="https://stockaccess.io/#contactform">CONTACT US</a></li>

                            <li><a href="{{route('testimony')}}">TESTIMONIES</a></li>

                            <li><a href="{{route('faq')}}">FAQ</a></li>

                            <li><a href="{{route('terms')}}">Legal and Terms</a></li>

                            <li class="dropdown"><a href="#">CLIENT AREA</a>
        ...
        <div id="slider" class="inspiro-slider dots-creative" data-height-xs="360">
            ...
            <div class="slide kenburns"
                style="background-image:url('site-images/WZMH-Architects-National-Bank-Trading-Floor-Toronto.jpg');">
        ...
        <section class="theme-bg" style="padding-top:40px; padding-bottom: 20px;">
            <div class="container">
                <div class="uk-text-center">
                    <div class="in-icon-wrapper circle uk-margin-remove-bottom">
                        <span data-uk-icon="icon:fa-medal; ratio: 0.054" class="uk-icon"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="27.648" height="27.648"
                                data-svg="fa-medal">
                                <path
                ...
                <div class="heading-text heading-line text-center">
                    <p data-animate="zoomIn" style="color: #fff !important;">Stock Access</p>
                </div>
                <div class="row">
                    <div class="col-lg-12" data-animate="bounceInDown" style="max-width: 970px;margin: auto;">
                        <h2 style="font-size: 23px; margin-bottom: 0; color: #fff !important;" class="tup text-center">
                            WHY CHOOSE STOCK ACCESS?</h2>
                        <p class="text-center" style="color: #fff !important;">
                            In Stock access,we securely Manage  investors stock as an asset management company that we are by combining our deep knowledge of local markets with the power of coordinated global oversight to derive better investment outcomes for our customers.
                        ...
                        <div class="row">
                            <div class="col-md-2 card" style="height: 150px;display: flex;align-items: center;justify-content: center;margin: auto;">
                                ...
                                <p class="card-subtitle">Verified users</p>
                            </div>
                            <div class="col-md-2 card" style="height: 150px;display: flex;align-items: center;justify-content: center;margin: auto;">
                                <h3 class="card-title">$176B</h3>
                                <p class="card-subtitle">Quarterly volume traded</p>
                            </div>
                            <div class="col-md-2 card" style="height: 150px;display: flex;align-items: center;justify-content: center;margin: auto;">
                                <h3 class="card-title">$35B</h3>
                                <p class="card-subtitle">Assets on platform</p>
                            </div>
                            <div class="col-md-2 card" style="height: 150px;display: flex;align-items: center;justify-content: center;margin: auto;">
                    ...
                    <div class="uk-width-1-1 in-wave-16">
                        <div class="in-margin-medium-top@s">
                            <div class="uk-grid" data-uk-grid="">
                                <div
                                    class="uk-width-expand@s uk-width-2-5@m uk-card-media-right uk-cover-container uk-first-column">
                                    <img class="uk-width-1-1 uk-margin-remove-bottom" src="img/in-wave-image-2.jpg"
                                        alt="sample-image">
                                </div>
                                <div class="uk-width-1-2@s uk-width-expand@m uk-flex uk-flex-middle">
                                    <div class="">
                                        <h1 class="uk-margin-top uk-margin-remove-bottom"
                                            style="text-transform: uppercase; font-size: 22px">Trusted by more than 45
                                        ...
                                        <p class="uk-margin-small-top uk-margin-bottom">We’ve been consistently
                                            ...
                                            services.</p>
                                        <hr class="">
                                        <div class="uk-child-width-1-3@m uk-text-center uk-visible@m uk-grid"
                                            data-uk-grid="">
                                            <div class="uk-first-column">
                                                <img src="img/in-wave-award.svg" alt="wave-award">
                    ...
                    <div class="col-lg-6 p-l-40 p-r-40" data-animate="fadeInRight">
                        <div class="m-b-40 f15">
                            ...
                            <p style="color: #fff !important"> We’re proud to be an asset management company whose
                                ...
                                and a long-term vision. At Stock Access Group Investments, our vision, mission and
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <img alt="" style="width: 100% !important;"
                            src="site-images/compressed-assets/image-4-compressed.jpg">
                    </div>
                </div>
        ...
        <section style="height: 80vh_; min-height: 400px; object-fit: cover;"
            ...
            <div class="html5vid video-loaded" id="video-rpptn"><video playsinline="" style="object-fit: cover;"
            ...
            <div class="container container-fullscreen">
                <div class="text-middle text-center text-light">
                    <h1 class="text-uppercase text-lg headng_stef d-font-exempt"
                        style=" font-size: 26px !important; margin-bottom: 0; color: #fff !important">Stock Access</h1>
                    <p class="lead">
        ...
        <div id="kkssks"
            class="uk-section uk-section-muted uk-padding-remove-vertical uk-background-contain uk-background-center-right uk-background-image@m"
            style="background-image: url(img/in-wave-platformbg.jpg);">
            <div class="uk-container in-wave-18">
                <div class="uk-grid-large uk-flex uk-flex-middle uk-grid" data-uk-grid="">
                    <div class="uk-width-1-2@m uk-first-column">
                        <div class="uk-margin-bottom hide-on-mobile yuwj8jwkk2ikwlw">
                            <a href="#kkssks" class="uk-button in-button-app">
                                <img class="uk-align-center btc-crypto-logo" src="img/awards/alkar.svg"
                                    data-src="img/monee-payment-mastercard.svg" alt="monee-mastercard" width="103"
                                    height="32" data-uk-img="">
                            </a>
                            <a href="#kkssks" class="uk-button in-button-app uk-margin-medium-left">
                                <img class="uk-align-center" src="img/awards/brandywine-realty-24808.svg"
                                    data-src="img/monee-payment-paypal.svg" alt="monee-paypal" width="103" height="32"
                                    data-uk-img="">
                            </a>
                            <a href="#kkssks" class="uk-button in-button-app uk-margin-medium-left uk-visible@m">
                                <img class="uk-align-center" src="img/awards/multex-investor.svg"
                                    data-src="img/monee-payment-unionpay.svg" alt="monee-unionpay" width="103"
                                    height="32" data-uk-img="">
                            </a>
                        </div>
                    ...
                    <div class="uk-width-1-2@m">
                        <img class="uk-align-center uk-align-left@m" src="img/in-wave-mockup-5.png" alt="wave-mockup"
                        ...
                        <div class="carousel arrows-visibile testimonial testimonial-single testimonial-left"
                            ...
                            <div class="testimonial-item">
                                ...
                                <p>I've had incredible customer service since i started investing here, I'm a repeat
                                    investor. I've been investng with Stock Access Groups Investments for nearly 3
                            ...
                            <div class="testimonial-item">
                                ...
                                <p>Transparent, profitable, and reliable bitcoin investment company that will make you
                                    real money. Thanks to all of you at Stock Access Group for the excellent
                                    service. </p>
                            ...
                            <div class="testimonial-item">
                                ...
                                <p>I have always been searching for an opportunity to earn on bitcoin and finally I
                                    found Stock Access Group and they have proven to be very reliable since i've
                    ...
                    <div class="uk-width-1-1@m">
                        <div class="uk-grid uk-grid-small" data-uk-grid="">
                            <div class="uk-width-auto@m uk-first-column">
                                <div class="in-icon-wrapper circle large theme-color uk-margin-small-right"> <i
                                        class="fas fa-money-bill-wave fa-2x"></i> </div>
                            </div>
                            <div class="uk-width-expand">
                                <h3 class="tup" style="color: #fff !important">Why Stock Access?</h3>
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1">
                        <div class="uk-card uk-card-secondary uk-background-center-right uk-background-contain uk-background-image@m"
                            style="background-image: url(site-images/compressed-assets/image-6-compressed.jpg);">
        ...
        <section class="box-fancy theme-bg hy8ikeol section-fullwidth text-light"
                ...
                <div class="row yu8i9kl-uuh">
                    <div style="" class="col-lg-4">
                        ...
                        <span>Empowering investors by providing them an avenue for controlling their financial future by
                            ...
                            traditional assets.
                            Stock Access Group is dedicated to helping investors around the world reach
                    ...
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="col-lg-12" data-animate="fadeIn"> We’re proud to be an asset management company
                                whose culture is driven by strong values and a long-term vision. At Stock Access
                                ...
                                Stock Access Group was founded on a simple but revolutionary idea that an
                                investment company
                                should be run for the sole benefit of its investors. And so Stock Access Group was
                                designed to be
                                different, removing outside owners and outside interests from the equation. Because of
                                our investor-owned structure, Stock Access Group's success can only be measured by
                                your success.
                            </div>
                            <div class="col-lg-12" data-animate="fadeIn"> Low costs, a long-term orientation, and focus
                                on your goals are at the core of
                                Stock Access Group's investing philosophy, and not just because they sound good.
                                They're essential
                                ...
                                Stock Access Group's mission is to help investors reach their goals, and that
                                means access to
                                ...
                                Strategy matters. Stock Access Group's approach to managing investments on behalf
                                of our clients is
    ...
    <div class="container">
      <div class="row text-center row1">
        <div class="col-md-4">
          ...
          <h5 style="color: #fff!important;">Send Us A Message</h5>
