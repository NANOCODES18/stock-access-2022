...
@section("body")
    ...
    <section class="homefront">
      ...
      <div class="text">
        <h1 style="text-align:center">STOCK ACCESS </h1><br> <br><h1> BONDS, CRYPTO, FOREX, STOCKS ETC</h1>
        ...
        <div class="container">
          ...
          <div class="row" style="margin-top: 100px;">
            <div class="col-md-6">
              ...
              <a href="{{route('register')}}" style="width: fit-content;">Start Trading</a>
    ...
    <section id="third">
      <div class="container">
        ...
        <h6>Discover why millions trade with Stock access</h6>
        <div class="row">
          <div class="col-md-4">
    ...
    <section id="second">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6">
              <h2>invest In a diverse portfolio</h2>
              <ul>
    ...
    <section id="fifth2">
      ...
      <div id="carouselExampleIndicators" class="carousel slide thecarousel" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/17.jpg" alt="First slide" style="height: 500px;position: relative;">
            <div class="testi" >
              <h3>Meet Our Popular Investors</h3>
              <p style="font-size: 25px;"><q>Stock Access is a fantastic trading platform, both from an ease of use and technical perspective.</q></p>
            </div>
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="images/18.jpg" alt="Second slide" style="height: 500px;position: relative;">
            <div class="testi" >
              <h3>Meet Our Popular Investors</h3>
              <p style="font-size: 25px;"><q>I am very satisfied with the services Stock Access platform provides</q></p>
            </div>
            <div class="carousel-caption " style="display: block;">
              <h5>ANGELINA</h5>
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="images/19.jpg" alt="Third slide" style="height: 500px;position: relative;">
            <div class="testi" >
              <h3>Meet Our Popular Investors</h3>
              <p style="font-size: 25px;"><q>Great service. Fast feedback. Social forum give a lot of info</q></p>
            </div>
            <div class="carousel-caption " style="display: block;">
              <h5>ALBERT</h5>
              <p>FROM IRELAND</p>
      ...
      <div class="container">
        ...
        <div class="row row2">
          ...
          <div class="col-md-4">
            ...
            <h6>Trade and invest in top stocks and ETFs. Trade currency pairs, indices and commodities via CFDs. Investing in the financial market has never been easier.</h6>
        ...
        <div class="row row3">
          ...
          <div class="col-xs-2 col-2">
            <i class="fab fa-cc-visa" style="color:#15195A"></i><br>
          </div>
          <div class="col-xs-2 col-2">
            <i class="fab fa-cc-paypal" style="color: #169BD7"></i><br>
          </div>
          <div class="col-xs-2 col-2">
            <i class="fab fa-cc-stripe" style="color: #5433FF"></i><br>
          </div>
          <div class="col-xs-2 col-2">
            <i class="fab fa-cc-visa" style="color:#15195A"></i><br>
          </div>
